...
package xmut.ygnn.petstore.video.utils;
...
public class PlayControlUtil {
    ...
    public static void setIsSurfaceView(boolean isSurfaceView) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.isSurfaceView = isSurfaceView;
    }
    ...
    public static void setVideoType(int videoType) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.videoType = videoType;
    }
    ...
    public static void setIsMute(boolean isMute) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.isMute = isMute;
    }
    ...
    public static void setPlayMode(int playMode) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.playMode = playMode;
    }
    ...
    public static void setBandwidthSwitchMode(int bandwidthSwitchMode) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.bandwidthSwitchMode = bandwidthSwitchMode;
    }
    ...
    public static void setInitBitrateEnable(boolean initBitrateEnable) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.initBitrateEnable = initBitrateEnable;
    }
    ...
    public static void setInitType(int initType) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.initType = initType;
    }
    ...
    public static void setInitBitrate(int initBitrate) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.initBitrate = initBitrate;
    }
    ...
    public static void setInitWidth(int initWidth) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.initWidth = initWidth;
    }
    ...
    public static void setInitHeight(int initHeight) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.initHeight = initHeight;
    }
    ...
    public static void setTakeEffectOfAll(boolean takeEffectOfAll) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.takeEffectOfAll = takeEffectOfAll;
    }
    ...
    public static void setCloseLogo(boolean closeLogo) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.closeLogo = closeLogo;
    }
    ...
    public static void setMinBitrate(int minBitrate) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.minBitrate = minBitrate;
    }
    ...
    public static void setMaxBitrate(int maxBitrate) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.maxBitrate = maxBitrate;
    }
    ...
    public static void setLoadBuff(boolean isLoadBuff) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.isLoadBuff = isLoadBuff;
    }
    ...
    public static void setInitResult(int initResult) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.initResult = initResult;
    }
    ...
    public static void setPreloader(Preloader preloader) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.preloader = preloader;
    }
    ...
    public static void setSubtitlePresetLanguage(String language) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.subtitlePresetLanguage = language;
    }
    ...
    public static void setInitBufferTimeStrategy(InitBufferTimeStrategy initBufferTimeStrategy) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.initBufferTimeStrategy = initBufferTimeStrategy;
    }
    ...
    public static void setPreferAudio(String preferaudio) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.preferAudio = preferaudio;
    }
    ...
    public static void setProxyInfo(Proxy proxy) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.socksProxy = proxy;
    }
    ...
    public static void setIsDownloadLinkSingle(boolean isDownloadLinkSingle) {
        xmut.ygnn.petstore.video.utils.PlayControlUtil.isDownloadLinkSingle = isDownloadLinkSingle;
    }
